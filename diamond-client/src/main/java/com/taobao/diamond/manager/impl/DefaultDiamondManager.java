...
public class DefaultDiamondManager implements DiamondManager {
    ...
    {
    	this(group,dataId,managerListener,null,null);
    }

    public DefaultDiamondManager(String group, String dataId, ManagerListener managerListener,String diamondServer,String diamondPort) {
        this.dataId = dataId;
        this.group = group;

        diamondSubscriber = DiamondClientFactory.getSingletonDiamondSubscriber();
        if(!StringUtils.isEmpty(diamondServer) && !StringUtils.isEmpty(diamondPort))
        {
        	diamondSubscriber.getDiamondConfigure().setConfigServerAddress(diamondServer);
        	diamondSubscriber.getDiamondConfigure().setConfigServerPort(Integer.parseInt(diamondPort));
        }
    ...
    {
    	this(group,dataId,managerListenerList,null,null);
    }
    /**
     ...
     * @param clusterType
     */
    public DefaultDiamondManager(String group, String dataId, List<ManagerListener> managerListenerList,String diamondServer,String diamondPort) {
        this.dataId = dataId;
        this.group = group;
