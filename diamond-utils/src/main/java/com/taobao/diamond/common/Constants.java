...
public class Constants {
    ...
    public static final String DEFAULT_DOMAINNAME = "configlist.kuangtuzhm.com";

    public static final String DAILY_DOMAINNAME = "configinfo.kuangtuzhm.com";

    public static final int DEFAULT_PORT = 8686;
    
    public static final int DEFAULT_SERVERLIST_PORT = 8686;
    ...
    public static final String SERVER_LIST_FILE = "ServerListAddress";
